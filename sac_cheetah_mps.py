...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        # They will be moved to the correct device in the agent's training step.
...
class MLPGaussianPolicy(nn.Module):
    def __init__(self, state_dim, action_dim, hidden_dims=(256, 256,), activation_fn=F.relu):
        ...
        # These will be moved to the correct device when the module is moved.
        self.register_buffer('action_scale', torch.FloatTensor([1.0]))
        self.register_buffer('action_bias', torch.FloatTensor([0.0]))
...
class SAC:
    def __init__(
        ...
        # Replay buffer now stores data on CPU.
        # Data will be moved to the device in the training step.
    ...
    def step(self, transition):
        ...
        # Move data to the training device (e.g., MPS, CUDA, or CPU)
